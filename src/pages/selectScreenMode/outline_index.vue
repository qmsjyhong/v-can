	...
	<div class="selectScreenMode">
		...
		<div class="vx-container">
			...
			:show="showquickScreen"
			 ...
			 :getQuickPointScreens="getQuickPointScreens"
			 :boxParam="boxParam"
			 ></quick-screen>
		<selectNetworkPort v-if='showNetworkPort' :show="showNetworkPort" @nextStep="nextStep"></selectNetworkPort> 
...
<script>
    ...
    //         }
				...
				// 	});
				this.boxParam = {height :128, width :128};
			...
			getPortSize() {
				...
				// 	});
					this.portNumber = {portSize:6, modelId:25089};
			},
			formatResolution() {
    ...
    //         }
				...
				// 		this.getQuickPointScreen();
				// 	});
				this.resolution = {rate: 60, height: 640,width: 640};
			},
			qcCancel() {
    ...
    //         }
			...
			save(obj) {
				this.showquickScreen = false;
				// // this.quickPointScreen.walkType = obj.walkType;
				// let params= {};
